...
public class Rectangle extends JFrame {
    ...
    public Rectangle() {
        super("Shapes Learning App - Rectangle Descriptions");
        ...
        backButton.addActionListener(new Rectangle.BackButtonActionListener());
        topPanel.add(backButton);

        // Add the title label to the top panel
        JLabel titleLabel = new JLabel("Let's Learn About Rectangle");
        ...
        // Add the description cards for the Rectangle
        JPanel RectangleCard1 = createDescriptionCard("A rectangle is a closed 2-D shape, having 4 sides, 4 corners, and 4 right angles (90°). The opposite sides of a rectangle are equal and parallel. Since, a rectangle is a 2-D shape, it is characterized by two dimensions, length, and width. Length is the longer side of the rectangle and width is the shorter side.", "E:\\untitled1\\media\\learnRect.png");
        shapePanel.add(RectangleCard1);

        JPanel RectangleCard2 = createDescriptionCard("Looking around, you can find many things that resemble the rectangle shape. Common examples of this shape include a black-board, letters, doors, cupboard, popsicle, etc.", "E:\\untitled1\\media\\rectEx.png");
        shapePanel.add(RectangleCard2);
    ...
    private class NextButtonActionListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (cardIndex < shapePanel.getComponentCount() - 1) {
                ...
                if (cardIndex == shapePanel.getComponentCount() - 1) {
                    nextButton.setText("Let's Create a Rectangle");
                    nextButton.addActionListener(new ActionListener() {
                        @Override
                        public void actionPerformed(ActionEvent e) {
                            String buttonText = nextButton.getText();
                            if (buttonText.equals("Let's Create a Rectangle")) {
                                RectangleGenerator rectangleGenerator = new RectangleGenerator();
                                rectangleGenerator.setVisible(true);
                                dispose();
                            }
                        }
                    });
