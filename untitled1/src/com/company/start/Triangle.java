...
public class Triangle extends JFrame {
    ...
    public Triangle() {
        super("Shapes Learning App - Triangle Descriptions");
        ...
        backButton.addActionListener(new Triangle.BackButtonActionListener());
        topPanel.add(backButton);

        // Add the title label to the top panel
        JLabel titleLabel = new JLabel("Let's Learn About Triangle");
        ...
        // Add the description cards for the Triangle
        JPanel TriangleCard1 = createDescriptionCard("A triangle is a closed shaped object which is made up of three sides and also consists of three edges and three vertices.", "E:\\untitled1\\media\\learnTri.png");
        shapePanel.add(TriangleCard1);

        JPanel TriangleCard2 = createDescriptionCard("Looking around, you can find many things that resemble the Triangle shape. Common examples of this shape include a sandwich, pizza slice, triangular ruler, traffic sign, nachos chips, etc.", "E:\\untitled1\\media\\TriEx.png");
        shapePanel.add(TriangleCard2);
    ...
    private class NextButtonActionListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (cardIndex < shapePanel.getComponentCount() - 1) {
                ...
                if (cardIndex == shapePanel.getComponentCount() - 1) {
                    nextButton.setText("Let's Create a Triangle");
                    nextButton.addActionListener(new ActionListener() {
                        @Override
                        public void actionPerformed(ActionEvent e) {
                            String buttonText = nextButton.getText();
                            if (buttonText.equals("Let's Create a Triangle")) {
                                TriangleGenerator triangleGenerator = new TriangleGenerator();
                                triangleGenerator.setVisible(true);
                                dispose();
                            }
                        }
                    });
